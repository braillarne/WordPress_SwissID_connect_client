<?php
 ...
 function customization_ui(){	
	...
	<form id="form-common" name="form-common" method="post" action="admin.php?page=mo_oauth_settings&tab=customization">
		...
		<div style="padding:15px 0px 15px;"><h2 style="display: inline;">Customize Icons <small><a href="admin.php?page=mo_oauth_settings" target="_blank" rel="noopener noreferrer">[STANDARD]</a></small></h2><span style="float: right;">[
...
<pre>.oauthloginbutton{
	...
	color:#fff;
			...
			<tr>
				...
				<td><input type="text" style="resize: vertical; width:200px; height:30px;  margin:5% auto;" placeholder ="Howdy ,##user##"> <b>##user##</b> is replaced by Username</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<!--<td><input disabled value=" 	Save settings " class="button button-primary button-large" /></td>-->
				<td><input value=" 	Save settings " class="button button-primary button-large" /></td>
			</tr>
		</table>
	</form>
	</div>
